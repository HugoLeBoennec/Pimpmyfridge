...
public class Frame extends java.awt.Frame
{
    ...
    private void initComponents()
    {
        ...
        num_r.setAlignment(java.awt.Label.RIGHT);
        num_r.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        num_r.setFont(new java.awt.Font("Dialog", 3, 14)); // NOI18N
        panel_center.add(num_r);

        num_c.setAlignment(java.awt.Label.RIGHT);
        num_c.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        num_c.setFont(new java.awt.Font("Dialog", 3, 14)); // NOI18N
        panel_center.add(num_c);

        num_t.setAlignment(java.awt.Label.RIGHT);
        num_t.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        num_t.setFont(new java.awt.Font("Dialog", 3, 14)); // NOI18N
        panel_center.add(num_t);

        num_h.setAlignment(java.awt.Label.RIGHT);
        num_h.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        num_h.setFont(new java.awt.Font("Dialog", 3, 14)); // NOI18N
    ...
    private view.Graph graph;
    private java.awt.Label label_c;
    private java.awt.Label label_h;
    private java.awt.Label label_r;
    private java.awt.Label label_t;
    private java.awt.Label num_c;
    private java.awt.Label num_h;
    private java.awt.Label num_r;
    private java.awt.Label num_t;
